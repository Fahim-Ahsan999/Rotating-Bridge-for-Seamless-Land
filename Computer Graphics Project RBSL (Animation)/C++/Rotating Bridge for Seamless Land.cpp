...
glEnd();
glBegin(GL_QUADS);
    glColor3ub(180,180,180);//devider
    glVertex2f(20.0f, -8.75f);
    glVertex2f(50.0f, -8.75f);
    glVertex2f(50.0f, -7.0f);
    glVertex2f(20.5f, -7.0f);
...
void rotationBridgeRight(){
    ...
    glEnd();
    glBegin(GL_LINES);
    glColor3ub(104, 68, 53);
    glVertex2f(14.0f+xrigth, -19.9f+yright);
    ...
    glVertex2f(1.0f+xrigth, -8.75f+yright);
    glVertex2f(19.0f, -8.75f);
    glEnd();

    glBegin(GL_LINES);//whiteLine Right
    glColor3ub(255,255,255);
    glVertex2f(1.0f+xrigth, -8.25f+yright);
...
//All ARe for pilar Stand..........
    ...
    glColor3ub(255,255,255);
    glVertex2f(-19.0f, -8.75f);
    glVertex2f(-1.0f+X, -8.75f+Y);
    glEnd();

    glBegin(GL_LINES);//whiteLine left
    glColor3ub(255,255,255);
    glVertex2f(-19.0f, -8.25f);
    glVertex2f(-1.0f+X, -8.25f+Y);
    glEnd();
...
void windmill(float translationX, float translationY){
    ...
    windmillBlades(-5.0f,0.0f);
    windmillBlades(5.0f,0.0f);
    windmillBlades(20.0f,0.0f);
    windmillBlades(35.0f,0.0f);
    windmillBlades(45.0f,0.0f);
...
void displayScene2Morning() {
   ...
   prerequisideRotating();
    ...
    raindrops();
    treeTriangle(80.0f, -36.48f);
    treeTriangle(84.0f, -36.48f);
    treeTriangle(95.0f, -36.48f);
    treeCircle(87.0f, -36.48f);
    treeCircle(83.0f, -36.48f);



    treeTriangle(2.0f,-36.48f);
    treeTriangle(5.0f,-36.48f);
    treeCircle(4.5f, -36.48f);
    treeTriangle(15.0f,-36.48f);
    treeTriangle(12.0f,-36.48f);
    treeTriangle(18.0f,-36.48f);
    treeTriangle(-1.0f,-36.48f);
